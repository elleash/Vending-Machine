...
while True: #loops throught the vending manchine until user wants to stop
    ...
    if choice == 2: #user chooses the second option
        print("The following items are:\n") #informs the user of the items in the specific category
    ...
    if choice == 3: #user chooses the third option
        print("The following items are:\n")#informs the user of the items in the specific category
    ...
    if choice == 5: #user chooses the fifth option
        print("The following items are:\n") #informs the user of the items in the specific category
        ...
        print("Invalid Input") #user has inputted an invalid option